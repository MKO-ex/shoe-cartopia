...
const Footer = () => {
  return (
    <footer className="bg-kam-blue text-white py-10 mt-24">
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#shoes" className="text-white/80 hover:text-white transition-colors">Shoes</a>
              </li>
              <li>
                <a href="#all-products" className="text-white/80 hover:text-white transition-colors">All Products</a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                ...
                <span className="text-white/80">contact@kamshoes.com</span>
              </li>
              <li className="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-white/80" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <li className="flex items-start">
                ...
                <span className="text-white/80">123 Shoe Street, Fashion City</span>
              </li>
            </ul>
          </div>
        </motion.div>
        ...
        >
          <p>&copy; {new Date().getFullYear()} KAM Shoes. All rights reserved.</p>
        </motion.div>
      </div>
    </footer>
  );
